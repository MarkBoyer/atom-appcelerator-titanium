...
export default class Toolbar {
	...
	constructor() {
		...
		this.state = {
			...
			hasLiveView: Appc.hasLiveViewHook(),
			useLiveView: false,
				...
				<div className="toolbar-row">
					...
					<div className="toolbar-left main-toolbar-group">
						...
						<div className="toolbar-item-title">
							<label class="input-label"><input class="input-checkbox" type="checkbox" checked={(this.state.disableUI || this.state.buildCommand !== 'run' || !this.state.hasLiveView) ? false : this.state.useLiveView} disabled={this.state.disableUI || this.state.buildCommand !== 'run' || !this.state.hasLiveView} on={{ change:this.useLiveViewDidChange }} />LiveView </label>
						</div>
	...
	getState() {
		...
		if (this.refs.useLiveView) {
			this.state.useLiveView = this.refs.useLiveView.value;
		}
	...
	/**
	* Use LiveView checkbox value changed
	*/
	useLiveViewDidChange() {
		this.state.useLiveView = !this.state.useLiveView;
		etch.update(this);
	}
